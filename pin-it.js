...
$('.pingoit').live('click',function(){ 
          ...
          if($.trim(video_time).length <= 0 ) alert("输入你分享的那么时间点");
          var video_comment = $(".pin_say").val();
          if($.trim(video_comment).length <= 0 ) alert("关于这个镜头，你想说些什么？");
